...
def parse_kgat_args():
    ...
    parser.add_argument('--nlp', type=str, default='vanilla',
                        help='Choose nlp method from {vanilla, keyword, similarity, embedding}')

    parser.add_argument('--use_embedding', type=int, default=0,
                        help='0: No entity BERT embedding, 1: Use entity BERT embedding')
    parser.add_argument('--data_size', type=str, default='normal',
    ...
    # parser.add_argument('--Ks', nargs='?', type=str, default='list(range(1,20))+[20,40,60,80,100]',
    #                     help='Calculate metric@K when evaluating.')
    parser.add_argument('--Ks', nargs='?', type=str, default='[1]+list(range(10,101,10))',
                        help='Calculate metric@K when evaluating.')
